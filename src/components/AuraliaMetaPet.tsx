...
import { getExpressionSvg, getExpressionSvgUrl } from "@/lib/expressionMap";
import type {
...
const AuraliaMetaPet: React.FC<AuraliaMetaPetProps> = ({
  ...
  // Derive expression SVG from current state
  const activeSvgUrl = useMemo(() => {
    const svg = getExpressionSvg({
      eyeEmotion: eyeState.emotion,
      expandedState: aiState.gbsp?.emotionalState ?? null,
      activeForm,
      health,
      energy,
      bond,
    ...
    return getExpressionSvgUrl(svg);
  }, [
    eyeState.emotion,
    aiState.gbsp,
    aiState.mode,
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {/* Expression SVG — replaces procedural ellipse body */}
                    <image
                      href={activeSvgUrl}
                      x="100"
                      y="60"
                      ...
                      style={{
                          ...
                          transformationMode === "squished"
                            ...
                            : transformationMode === "stretched"
                              ...
                              : transformationMode === "grumpy"
                                ? 0.95
                                : 1 - orbDeformation.intensity * 0.1
                        }, ${
                          transformationMode === "squished"
                            ? 0.85
                            : transformationMode === "stretched"
                        ...
                        opacity: transformationMode === "grumpy" ? 0.85 : 0.95,
                        filter:
                          transformationMode === "grumpy"
                            ? "sepia(0.4) hue-rotate(-20deg)"
                            : "none",
                      }}
                    />
                  </g>
                  ...
                  {activeForm !== "meditation" ? (
                    <EyeRenderer
                      eyeState={eyeState}
                      eyePos={eyePos}
                      leftEyeCenter={{ x: 180, y: 160 }}
                      rightEyeCenter={{ x: 220, y: 160 }}
                      annoyanceLevel={annoyanceLevel}
                    />
                  ) : (
                    <>
                      <path
                        d="M 175 165 Q 182 170 190 165"
                        stroke={currentForm.primaryGold}
                        strokeWidth="2"
                        fill="none"
                        opacity="0.6"
